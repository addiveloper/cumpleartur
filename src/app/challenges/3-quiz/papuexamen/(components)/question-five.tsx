...
import { QuestionFiveSchema } from "@/schemas/papuexamen";
...
export const QuestionFive = ({
  ...
  const form = useForm<z.infer<typeof QuestionFiveSchema>>({
    resolver: zodResolver(QuestionFiveSchema),
  });

  const handleSubmit = async (values: z.infer<typeof QuestionFiveSchema>) => {
    setIsLoading(true);
    setError("");
    try {
      ...
      <div className="flex w-full justify-between">
        <div>
          <p className="dark:text-neutral-400 text-neutral-600">
            Quinta papu-pregunta :v
          </p>
          <h2 className="font-bold text-3xl pb-16">
            ¿Cuál es la fecha de este evento?
          </h2>
        </div>
